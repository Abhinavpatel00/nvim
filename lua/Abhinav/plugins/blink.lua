  ...
  opts = {
    ...
    --    nerd_font_variant = 'mono',
        ...
        kind_icons = {
          ...
          Method = '🔧', -- Represents methods/tools
          Function = '🔨', -- Represents functions/tools
          Constructor = '🏗️', -- Represents constructors/building

          Field = '🌾', -- Represents fields
          Variable = '🧪', -- Represents variables/experiments
          Property = '🏠', -- Represents properties/house

          Class = '🎓', -- Represents classes/education
          Interface = '🖥️', -- Represents interfaces/screens
          Struct = '🏗️', -- Represents structs/structures
          Module = '📦', -- Represents modules/packages

          Unit = '📏', -- Represents units/measuring
          Value = '💎', -- Represents values/gems
          Enum = '🔢', -- Represents enums/numbers
          EnumMember = '📋', -- Represents enum members/lists

          Keyword = '🔑', -- Represents keywords/keys
          Constant = '📐', -- Represents constants/precision

          Snippet = '✂️', -- Represents snippets/scissors
          Color = '🎨', -- Represents colors/painting
          File = '📄', -- Represents files/documents
          Reference = '🔗', -- Represents references/links
          Folder = '📁', -- Represents folders/directories
          Event = '🎉', -- Represents events/celebrations
          Operator = '➕', -- Represents operators/math
          TypeParameter = '🔤', -- Represents type parameters/alphabet
        },
      },
    },
